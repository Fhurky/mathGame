...
public class User1_GUI extends JFrame {
    ...
    public User1_GUI() {
        ...
        mathOperations = new MathOperations(1);
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (currentIndex == numbers1.length-1) {
                    ...
                    yeni.duzenleIsim("resources/lastFive.txt","user2");
                    
                    YuksekPuanTablosu nTablo = new YuksekPuanTablosu("resources/skorTablosu.txt","user2");
                    nTablo.eklePuan(skor);
                    
                    
                    DosyaEkleme nDosya = new DosyaEkleme("user2",correctCount,wrongCount,skor);
                    nDosya.ekleBilgi();
        ...
        btnNewButton_1.setBounds(328, 297, 162, 77);
